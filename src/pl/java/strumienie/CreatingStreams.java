...
public class CreatingStreams {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var contets = Files.readString(path);
        ...
        Stream<String> wordsAnotherWay = Pattern.compile("\\PL+").splitAsStream(contets);
        show("wordsAnotherWay", wordsAnotherWay);

        Stream<String> scannerWay = new Scanner(contets).tokens();
